<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <ol class="breadcrumb">
          <li class="active">
            <a href="<?php echo BASE_MODULE_URL; ?>goal_segment/create"><button type="reset" class="btn btn-success">Add Segment</button>
            </a>
        </li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <?php } ?>            <!-- /.box -->
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <table id="list_segments" class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th>Segment Id</th>
                    <th>Segment Name</th>
