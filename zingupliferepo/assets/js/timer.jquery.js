...
(function ($) {
    ...
    var intr,
            ...
            options = {
                ...
                callback: function () {
//                    alert('Your time period for Completing booking process has been over pleae try again !!!');
//                    location.reload();
                    stopTimerInterval();
                },
                repeat: false, // this will repeat callback every n times duration is elapsed
                countdown: true, // if true, this will render the timer as a countdown if duration > 0
    ...
    function secondsToTime(sec) {
        ...
        if (options.format) {
            ...
            if (timeObj.hours) {
                ...
                if (timeObj.minutes) {
                    time = timeObj.minutes + ':' + timeObj.seconds + ' ' + 'minutes';
                } else {
                    time = timeObj.seconds + ' seconds';
                }
            }
        }
        return time;
