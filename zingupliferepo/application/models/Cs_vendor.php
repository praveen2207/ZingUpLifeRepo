 ...
 * 
 * */
class Cs_vendor extends CI_Model {
...
// Call the Model constructor
    ...
    public function insert_business_programs($postdata) {
        $business_details = $this->Cs_vendor->get_business_details_by_id($postdata['business_id']);
	...
	//$slot_query = $this->db->query('select * from services_slots where service_id = "'.$service_id.'" order by DAY(date) asc');
        ...
        //echo '<pre>'; print_r($business_service_details) ;exit();
    }
