...
<div class="row-fluid vd-row">
    ...
    <form class="form-horizontal partner1 infob1for" name="service" method="post" action="<?php echo base_url(); ?>admin/updating_business_program">  
        <fieldset>
            <div class="clear">
                    ...
                    <tr>
                        ...
                        <td class="blue">
                            <ul class="backend-actions">
                                <li><a class="blue" href="<?php echo base_url(); ?>admin/business_service_edit/<?php echo $service->id; ?>">Edit</a></li>
                                <li>|</li>
