...
<div class="row-fluid vd-row">
    ...
    <div class="add_new"><a href="<?php echo base_url(); ?>admin/adding_package_service/<?php echo $business_id; ?> ">Add New</a></div>
                ...
                foreach ($services as $service) {
                    foreach ($service as $s) {
                        ...
                        <tr>
                            ...
                            <td class="blue"><?php echo $s->price; ?></td>
                             ...
                             <td class="blue">
                                 <ul class="backend-actions">
                                    <li><a class="blue" href="<?php echo base_url(); ?>admin/business_service_gallery/<?php echo $s->service_id; ?>">View Gallery</a></li>
                            ...
                            <td class="blue">
                                <ul class="backend-actions">
                                    <li><a class="blue" href="<?php echo base_url(); ?>admin/business_service_edit/<?php echo $s->service_id; ?>">Edit</a></li>
                                    <li>|</li>
