...
<div class="row-fluid tr-row">
    ...
    <?php if (count($business_gallery) < 6) { ?>
        <div class="add_new"><a href="<?php echo base_url(); ?>admin/add_business_gallery/<?php echo $business_id; ?>">Add Gallery</a></div>
    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td class="blue">
                            ...
                            <ul class="backend-actions">
                                <li><a class="blue" href="<?php echo base_url(); ?>admin/business_gallery_edit/<?php echo $gallery->id; ?>">Edit</a></li>
                                <li>|</li>
