...
<div class="row-fluid tr-row">
    ...
    <?php } ?>   
    <form class="form-horizontal for user-detail-row1 partner1 infob1" name="get_started" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/updating_business_gallery/<?php
