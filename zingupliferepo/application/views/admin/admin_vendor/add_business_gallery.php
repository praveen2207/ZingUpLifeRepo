...
<div class="row-fluid tr-row">
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_vendor_add_gallery" name="get_started" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/adding_business_gallery">  
        <fieldset>
            <div class="clear">
            </div>         
