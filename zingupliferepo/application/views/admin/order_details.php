...
<table>
	...
	<td valign="top" align="left" width="250">
	    ...
	    <td align="right" cellpadding="" style=""><p style=""><?php if ($order_details['transactions']->booking_status == 'Success') { ?><i class="fa fa-check green c-check"></i>Confirmed<?php } else { ?>Not Confirmed <?php } ?></p></td>
    ...
    <?php $current_time = date('y-m-d'); if(strtotime($order_details['transactions']->date) > strtotime($current_time)){ ?><a class="sign-link sign-now-link" href="<?php echo base_url(); ?>customer_support/reschedule_order/<?php echo $order_details['transactions']->booking_id; ?>"><i class="fa fa-angle-right sign-arrow"></i> Re-schedule this order</a>
