...
<script>
     function show_details(ip_address,page_name,selected_date){
         var sitepath = '<?php echo base_url();?>';
         var page_name=$('#page').val();
         $.ajax({
             type: 'POST',
             url: sitepath+'admin/analytics_controller/view_details',
             dataType: 'json',
             data: {
