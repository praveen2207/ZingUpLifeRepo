...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/admin/css/admin_custom.css" rel="stylesheet">
                ...
                <?php } else {
                    ...
                    <div class="nav-collapse">
                      ...
                      <ul class="user-menu-section">
                            ...
                            <?php if ($sub_url == 'admin/business_info') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_information/<?php echo $business_id; ?>" class="admin_menu_link nav-sel">Business information</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_information/<?php echo $business_id; ?>" class="admin_menu_link">Business information</a></li>
                            <?php } ?>

                            <?php if ($sub_url == 'admin/packages_treatments') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/packages_treatments/<?php echo $business_id; ?>" class="admin_menu_link nav-sel">Packages/Treatments</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/packages_treatments/<?php echo $business_id; ?>" class="admin_menu_link">Packages/Treatments</a></li>
                            <?php } ?>
                             <?php if ($sub_url == 'admin/business_services') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_services/<?php echo $business_id; ?>" class="admin_menu_link nav-sel">Business services</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_services/<?php echo $business_id; ?>" class="admin_menu_link">Business services</a></li>
                            <?php } ?>
                                <?php if ($sub_url == 'admin/business_services_slots') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_service_slots/<?php echo $business_id; ?>" class="admin_menu_link nav-sel">Business Hours</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/business_service_slots/<?php echo $business_id; ?>" class="admin_menu_link">Business Hours</a></li>
                            <?php } ?>
                             <?php if ($sub_url == 'admin/one_day_packages') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/one_day_packages/<?php echo $business_id; ?>" class="admin_menu_link nav-sel">One day packages</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/one_day_packages/<?php echo $business_id; ?>" class="admin_menu_link">One day packages</a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    <?php
