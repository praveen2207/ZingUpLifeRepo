                    ...
                    <div class="feedbacktab-tabs-container">
								<div class="dashboard-content-inner">
										<div class="product-list">
											<ul id="myList">
												<?php $i=0; foreach($events as $ar) { $i++; if($i==9) break;?>
												<a href="<?php echo base_url(); ?>events/detailpage/<?php echo $this->uri->segment(3); ?>/<?php echo $ar->id; ?>">
													<li>
														<div class="product-inner">
															<div class="product-list-image">
																<img alt="" src="<?php echo base_url();?>sme_users/events/<?php echo $ar->id; ?>/<?php echo $ar->photo[0]->name; ?>" style='height:200px;'></div>
															<div class="product-list-details">
																<h5><a href="#"><?php  echo $limited_string = word_limiter($ar->title, 8, '');?></a></h5> 
																<div class="item-head-img" style='padding-left:0px;'>
																	<p><span class="post-user"> on <?php echo date('d F, Y  h:i A',strtotime($ar->added_on));?> <br></span></p>                                       
																</div>                                       
															</div>
														</div>
													</li>
										...
										<?php if(count($events) > 8) { ?>
											<div class="row">
														<div class="col-xs-5 mar-auto">
															<button onclick="smeevloadmore()" value="loadmore" id="load-more" class='sme-ev-loadmore' >View More</button>
