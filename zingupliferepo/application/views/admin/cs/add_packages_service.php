...
<div class="row-fluid tr-row">
    ...
    <?php } ?>
    <form class="form-horizontal partner1 infob1 for" name="services" method="post" id="cs_vendor_packages_treatments_form" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/adding_business_services">  
        <fieldset>
            <div class="clear">
...
<div id="cs_error_popup_service_name" style="display:none;color:red;">This field is required</div>
      <br><br><br>

        Package/Treatment<br>
        <input type="text" class="package" name="package" style="float:none;" />
<div id="cs_error_popup_package_name" style="display:none;color:red;">This field is required</div>       
        <br><br>
 ...
 <div id="cs_error_popup_type" style="display:none;color:red;">This field is required</div> 
<br>
