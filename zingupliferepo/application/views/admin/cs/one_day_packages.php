...
<div class="row-fluid vd-row">
    ...
    <div class="add_new"><a href="<?php echo base_url(); ?>cs/add_one_day_package/<?php echo $business_id; ?> ">Add New</a></div>
                    ...
                    <tr>
                        ...
                        <td class="blue">
                            <ul class="backend-actions">
                                 <li><a class="blue" href="<?php echo base_url(); ?>cs/one_day_package_edit/<?php echo $package->id._.$package->service_id; ?>">Edit</a></li>
                                    <li>|</li>
