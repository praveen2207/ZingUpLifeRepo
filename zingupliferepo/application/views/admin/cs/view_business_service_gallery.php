...
<div class="row-fluid tr-row">
    ...
    <?php if (count($business_service_gallery) < 6) { ?>
        <div class="add_new"><a href="<?php echo base_url(); ?>cs/add_business_service_gallery/<?php echo $service_id; ?>">Add Service Gallery</a></div>
    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td class="blue">
                            ...
                            <ul class="backend-actions">
                                <li><a class="blue" href="<?php echo base_url(); ?>cs/business_service_gallery_edit/<?php echo $gallery->id; ?>">Edit</a></li>
                                <li>|</li>
