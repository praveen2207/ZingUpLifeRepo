...
<div class="row-fluid tr-row">
    ...
    <?php } ?>   
    <div class="add_new"><a href="<?php echo base_url(); ?>cs/view_business_gallery/<?php echo $business_info['business']->id; ?> ">View Gallery</a></div>
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_business_info_form" name="get_started" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/adding_business_information">  
        <fieldset>
            <div class="clear">
