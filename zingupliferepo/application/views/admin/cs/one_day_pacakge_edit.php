...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_vendor_one_day_pacakge_edit" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/update_one_day_packages">  
        <fieldset>
            <div class="clear">
