...
<!--                <i class="fa fa-angle-down"></i>-->
 ...
 <div class='trans-tabledata' style='display:none;'>
        ...
        <tbody>
            <?php foreach ($all_customers as $key => $value) { ?>
                <tr>
                    ...
                    <td class="blue word_break"><a class="blue mail-id" href="<?php echo base_url(); ?>admin/customer_details/<?php echo $value->user_id; ?>"><?php echo $value->name; ?></a></td>
    ...
    <div class="filter-section admin-filter">
    ...
    <div class='customer-table'>
        ...
        <table id="admin_example1" class="display" cellspacing="0" width="100%" >
            <thead>
                <tr>
                    <th class="filter-input">Customer ID</th>
                    <th class="filter-input">Customer Name</th>
            ...
            <tbody id="admin_customers_filter">
                <?php foreach ($all_customers as $key => $value) { ?>
                    <tr>
                        <td class="blue"><?php echo $value->user_id; ?></td>
                        <td class="blue word_break word_break_down"><a class="blue mail-id" href="<?php echo base_url(); ?>admin/customer_details/<?php echo $value->user_id; ?>"><?php echo $value->name; ?></a></td>
                        <td><?php echo date('Y/m/d', strtotime($value->created_on)); ?></td>
                        <td><?php echo $value->gender; ?></td>
                        <td>
                            <?php
