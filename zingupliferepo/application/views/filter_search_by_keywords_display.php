        ...
        <div class="col-xs-12 col-sm-12 col-md-8">
            <ul>
                <?php if ($filter_data['keywords'] == '') { ?>
                    <li>
                        <button class="tagcontent search_category" id="spa">Spa&nbsp;<a class="ntdelbutton">x</a></button>
                    </li>
                    <li>
                        <button class="tagcontent search_category" id="yoga">Yoga&nbsp;<a class="ntdelbutton">x</a></button>
                    </li>
                    <li>
                        <button class="tagcontent search_category" id="ayurvedic_treatments">Ayurveda &nbsp;<a class="ntdelbutton">x</a></button>
                    </li>
                    <li>
                        <button class="tagcontent search_category" id="fitness">Fitness&nbsp;<a class="ntdelbutton">x</a></button>
                    </li>
                <?php } ?>
                <!--                        <li class="iconFil">
                ...
                <li>
                    <span>Showing&nbsp;</span>
                    <select class="selectpicker" data-style="btn-inverse" id="result_count1">
...
<script>
    $('body #result_count1').change(function () {
        var row_count = $(this).val();
        var keywords = $('body #keywords').val();
