...
<html>
    <head>
        ...
        if (isset($title) && $title != '') {
            ...
            $page_title = 'ZingUpLife | Corporate Offerings';
        }
        ?>
        <title><?php echo $page_title; ?></title>

        <meta charset="UTF-8">
            <meta name="description" content="It is very important to have a good workplace atmosphere, decreased medical leave, healthy food" />
                <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
                    <meta name="keywords" content="wellness solutions, stress management, workshops, wellness counselling, Pilates, healthy food, workplace"/>
                                                                                        ...
                                                                                        <?php if ($logged_in_user_data->image != '') { ?>
                                                                                            ...
                                                                                            <div class="collapse navbar-collapse zingList" id="zing-home-header">
                                                                                                <ul class="nav navbar-nav navbar-right">
                                                                                                    ...
                                                                                                    <?php } ?>
                                                                                                    <li><a href="<?php echo base_url(); ?>experts/home">EXPERTS</a></li>
