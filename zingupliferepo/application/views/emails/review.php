                ...
                <td>
                    ...
                    <table bgcolor="#ffffff"  align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 600px;margin:0 auto;">
                       ...
                       <![endif]-->
                        ...
                        <tr>
                            <td style="padding: 20px 45px;border-top:1px solid #bebebe;">
                                <table class="col370" align="left" border="0" cellpadding="0" cellspacing="0" style="">  
                                    <tr>
                                        <td>
                                            <span style="color:#444;font-size:21px;font-family: Quattrocento Sans, sans-serif">Welcome to Zing up Life</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <td style="text-align:left;font-size:41px;vertical-align:top;width:155px;">
                                            <p style="color:#444;font-weight:normal;padding:0px;margin:0px;font-family: Quattrocento Sans, sans-serif;font-size:17px;"> 
                                                ...
                                                <span style="color:#444;display:block;font-size:17px;line-height:27px;">
                                                    Please click on below link to review and rate your booking and service experience.
                                                </span>
                                            </p>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td style="padding: 20px 45px 100px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                    <tr>
                                        <td style="text-align:left; font-size:41px;vertical-align:top;width:155px;">
                                            <a target="_blank" href="<?php echo base_url(); ?>review/<?php echo $code; ?>" style="color:#444;background:#fff;display:block;width:85px;text-decoration:none;font-family: Quattrocento Sans, sans-serif;border:1px solid #088B2B;font-size:21px;color:#038d26;border-radius:4px;padding:5px 26px;font-weight:normal;line-height:normal;letter-spacing: 0.5px;height:auto;">
                                                Review
                                            </a>
                                        </td>
                                    </tr>
