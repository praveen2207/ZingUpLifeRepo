                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left;font-size:41px;vertical-align:top;width:155px;">
                                            <p style="color:#444;font-weight:normal;padding:0px;margin:0px;font-family: 'Quattrocento Sans', sans-serif;font-size:17px;"> 
                                                <label style="font-size:17px;color:#444;">Hi <?php echo $details->name; ?>,</label>
                                                <span style="color:#444;display:block;font-size:17px;line-height:27px;">
                                                    Welcome to ZingUpLife!<br><br>
                                                            We have received your details and our Partner Registration Team will get in touch soon.<br><br>
                                                                    Here are your account details:<br>
                                                                        Your  Login ID: <?php echo $details->username; ?><br><br>
                                                                                You can login to the partner module at <a href="http://www.zinguplife.com/partner">www.zinguplife.com/partner</a><br><br>
