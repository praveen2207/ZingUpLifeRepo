                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 right-content" >
                        <div class="business-info" style="clear:both;">
                            <form class="form-horizontal for" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>vendor/update_business_services_slots">
                                <label> Service name:</label>
                                <input type="text" id ="service_id" name="service_id" size="5" value ="<?php echo $services['details']->services; ?>" readonly/>
                                <input type="hidden" id ="service_id" name="service_id" size="5" value ="<?php echo $services['details']->id; ?>" readonly/>

                                <label> Select date:</label>

                                <select id="slots-date" multiple="multiple" name="slots_date[]">
                                    <?php
