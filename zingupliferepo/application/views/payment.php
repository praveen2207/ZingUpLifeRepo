    ...
    <div class="loginBox reHeight">
        ...
        <div class="row log_parents">
            <div class="col-sm-12 col-md-12 redirect_image">
                ...
                <h4 class="redirect-head">Please do not refresh or press back button. you are being redirected to the payment gateway...</h4>
                    ...
                    <div class="row-fluid notify" style="display:none;">
                        <div class="span12 no-border">
                            ...
                            <div class="tdetail-con">
                                <form method="post" name="customerData" action="<?php echo base_url(); ?>payment_process" id="paymentForm">
                                    ...
                                    <table width="40%" height="100" border='1' align="center">
                                        ...
                                        <tr>
                                            <td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?php echo base_url(); ?>paymentSuccess"/></td>
                                        </tr>
                                        <tr>
