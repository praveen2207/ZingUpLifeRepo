                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 right-content" >
                        <div class="business-info" style="clear:both;">
                            <form class="form-horizontal for" name="service" method="post" id="vendor_add_business_gallery" enctype="multipart/form-data" action="<?php echo base_url(); ?>vendor/create_gallery">
