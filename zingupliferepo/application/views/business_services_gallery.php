    ...
    <div class="content">
        <div class="container">        	
            <div class="page-head center">
                <h1><?php echo $gallery['details']->services; ?> Offering's Gallery</h1>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9 right-content" >
                        ...
                        <div class="business-info gallery_ctr" style="clear:both;">
                           <?php if (count($gallery['gallery']) <6) { ?>
                                <div class="add_new"><a class="button" href="<?php echo base_url(); ?>vendor/add_offerings_gallery/<?php echo $service_id ;?>">Add New</a></div>						 
                            <?php } ?>
                            <div class="clear"></div>
                            <table width="100%" cellspacing="0" class="table table-striped table-bordered" id="service_list_table">
                                <thead>
                                    <tr>
                                        <th>S. No.</th>
                                        <th>Image</th>
<!--                                        <th>Caption</th>
                                ...
                                <?php
                                foreach ($gallery['gallery'] as $key => $service_gallery) {
                                    ?>

                                    <tr style="border:solid 1px #000;">
                                        <td style="border:solid 1px #000;"><?php echo $key + 1; ?></td> 
                                        <td style="border:solid 1px #000;">
                                            <img class="services_gallery_img" src='<?php echo $gallery_path . $service_gallery->service_id . '/' . $service_gallery->images; ?>'/>
                                        </td> 
<!--                                        <td style="border:solid 1px #000;"><?php echo $service_gallery->caption; ?></td> 
                                        <td style="border:solid 1px #000; width: 300px;"><?php echo $service_gallery->description; ?></td> -->
                                        <td style="border:solid 1px #000;">
                                            <a class="terms_service" href="<?php echo base_url(); ?>vendor/offerings_gallery_edit/<?php echo $service_gallery->id; ?>"><strong>Edit</strong></a>
                                            /<a class="gallery_delete" id="<?php echo $service_gallery->id; ?>"><strong>Delete</strong></a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
...
<script>
    ...
    $('body').on('click', '.gallery_delete', function () {
        ...
        if (confirm("Are you sure you want to delete these image from gallery!!!") == true)
        {
            $.ajax({
                type: 'POST',
                url: base_url + 'vendor/offerings_gallery_delete',
                data: {id: id},
                dataType: "json",
