...
<?php if ( count( $terms ) > 0 ) : ?>
	...
	<ul class="woof_list woof_list_radio">
		...
		<?php foreach ($terms as $term) : ?>
			...
			<li <?php echo $class ?>>
				<a href="<?php echo esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) ?>" data-tax="<?php echo esc_attr($tax_slug) ?>" title="<?php echo esc_attr($term->name) ?>"><?php echo esc_html($term->name) ?></a>
			</li>
