		...
		<ul class="woof_list woof_list_color">
			...
			<?php foreach ($terms as $term) : ?>
				...
				<?php if ($colors[$term->slug] != ''): ?>
					<li <?php echo $class ?>>
						<a style="background-color: <?php echo esc_attr($colors[$term->slug]) ?>" href="<?php echo esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) ?>" data-tax="<?php echo esc_attr($tax_slug) ?>" title="<?php echo esc_attr($term->name) ?>"><?php echo esc_html($term->name) ?></a>
					</li>
				<?php endif; ?>
