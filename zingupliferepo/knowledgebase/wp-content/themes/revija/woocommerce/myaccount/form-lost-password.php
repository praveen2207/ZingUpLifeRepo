...
<form method="post" class="col-2 lost_reset_password">
    ...
    <p class="form-row ">
		<label for="">&nbsp;</label>
		<input type="submit" class="button button_grey" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? esc_html__( 'Reset Password', 'woocommerce' ) : esc_html__( 'Save', 'woocommerce' ); ?>" />
	</p>
