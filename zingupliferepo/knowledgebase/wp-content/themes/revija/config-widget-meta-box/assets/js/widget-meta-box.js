...
if ( $("#mad_header_layout option[value='header-main']").attr('selected') || $("#mad_header_layout option[value='header_3']").attr('selected')  || $("#mad_header_layout option[value='header_6']").attr('selected')  ) {
      $('.custom_sidebar_header').show();
} 
$('#mad_header_layout').change(function() {
    var selectVal = $('#mad_header_layout :selected').val();

    if (selectVal=='header-main' || selectVal=='header_3' || selectVal=='header_6') {
      $('.custom_sidebar_header').show('slow', function() {});
    } else {
      $('.custom_sidebar_header').hide('slow', function() {});
    }
});	
