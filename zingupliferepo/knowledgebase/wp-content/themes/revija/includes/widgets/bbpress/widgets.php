 ...
 * @uses WP_Widget
 */
class Mad_BBP_Login_Widget extends WP_Widget {
	...
	public function widget( $args = array(), $instance = array() ) {
		...
		if ( !is_user_logged_in() ) : ?>
			...
			<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="login_form_confirm bbp-login-form">
				<ul>
                
				<li>	
				<input type="text" name="log" value="<?php bbp_sanitize_val( 'user_login', 'text' ); ?>" size="20" id="user_login" tabindex="<?php bbp_tab_index(); ?>" /><i class="fa fa-user"></i>
				</li>	

				<li>
					<input type="password" name="pwd" value="<?php bbp_sanitize_val( 'user_pass', 'password' ); ?>" size="20" id="user_pass" tabindex="<?php bbp_tab_index(); ?>" /><i class="fa fa-lock"></i>
				</li>

				<li class="clearfix" >	
					<div class="bbp-remember-me">
						<input type="checkbox" name="rememberme" value="forever" <?php checked( bbp_get_sanitize_val( 'rememberme', 'checkbox' ), true, true ); ?> id="bbp-remember-me" tabindex="<?php bbp_tab_index(); ?>" />
						<label for="bbp-remember-me"><?php esc_html_e( 'Remember Me', 'bbpress' ); ?></label>
					</div>
				
						<?php //if ( !empty( $settings['lostpass'] ) ) : ?>

							<a href="<?php echo esc_url( $settings['lostpass'] ); ?>" title="<?php esc_attr_e( 'Lost Password', 'bbpress' ); ?>" class="f_right bbp-lostpass-link"><?php esc_html_e( 'Lost Password', 'bbpress' ); ?></a>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" name="user-submit" id="user-submit" tabindex="<?php bbp_tab_index(); ?>" class="button button_grey submit user-submit"><?php esc_html_e( 'Log In', 'bbpress' ); ?></button>
						...
						<?php if ( !empty( $settings['register'] ) ) : ?>
							...
							or <a href="<?php echo esc_url( $settings['register'] ); ?>" title="<?php esc_attr_e( 'Register', 'bbpress' ); ?>" class="bbp-register-link"><?php esc_attr_e( 'Register', 'bbpress' ); ?></a>
		...
		<?php else : ?>
			...
			<div class="bbp-logged-in  scale_image_container">
			...
			<div class="bbp-login-widget-in post_text">
	...
	public function form( $instance = array() ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title:', 'bbpress' ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'register' )); ?>"><?php esc_html_e( 'Register URI:', 'bbpress' ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'lostpass' )); ?>"><?php esc_html_e( 'Lost Password URI:', 'bbpress' ); ?>
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Views_Widget extends WP_Widget {
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Search_Widget extends WP_Widget {
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Forums_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'parent_forum' )); ?>"><?php esc_html_e( 'Parent Forum ID:', 'bbpress' ); ?>
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Topics_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = apply_filters( 'bbp_topics_widget_options', array(
			...
			'description' => esc_html__( 'A list of recent topics, sorted by popularity or freshness.', 'bbpress' )
		) );
	...
	public function form( $instance = array() ) {
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title'     )); ?>"><?php esc_html_e( 'Title:', 'bbpress' ); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title'     )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title'     )); ?>" type="text" value="<?php echo esc_attr( $settings['title']     ); ?>" /></label></p>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'max_shown' )); ?>"><?php esc_html_e( 'Maximum topics to show:', 'bbpress' ); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'max_shown' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'max_shown' )); ?>" type="text" value="<?php echo esc_attr( $settings['max_shown'] ); ?>" /></label></p>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Show post date:',    'bbpress' ); ?> <input type="checkbox" id="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_date' )); ?>" <?php checked( true, $settings['show_date'] ); ?> value="1" /></label></p>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'show_user' )); ?>"><?php esc_html_e( 'Show topic author:', 'bbpress' ); ?> <input type="checkbox" id="<?php echo esc_attr($this->get_field_id( 'show_user' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_user' )); ?>" <?php checked( true, $settings['show_user'] ); ?> value="1" /></label></p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'order_by' )); ?>"><?php esc_html_e( 'Order By:',        'bbpress' ); ?></label>
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Stats_Widget extends WP_Widget {
 ...
 * @uses WP_Widget
 */
class Mad_BBP_Replies_Widget extends WP_Widget {
			...
			<?php while ( $widget_query->have_posts() ) : $widget_query->the_post(); ?>
				...
				<li>
					...
					if ( ! empty( $settings['show_date'] ) && !empty( $author_link ) ) :
						...
						printf( '%1$s on %2$s %3$s', $author_link, $reply_link, '<div>' . bbp_get_time_since( get_the_time( 'U' ) ) . '</div>' );
					...
					elseif ( !empty( $author_link ) ) :
						...
						printf( '%1$s on %2$s', $author_link, $reply_link );
	...
	public function form( $instance = array() ) {
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title'     )); ?>"><?php esc_html_e( 'Title:', 'bbpress' ); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title'     )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title'     )); ?>" type="text" value="<?php echo esc_attr( $settings['title']     ); ?>" /></label></p>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'max_shown' )); ?>"><?php esc_html_e( 'Maximum replies to show:', 'bbpress' ); ?> <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'max_shown' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'max_shown' )); ?>" type="text" value="<?php echo esc_attr( $settings['max_shown'] ); ?>" /></label></p>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Show post date:',          'bbpress' ); ?> <input type="checkbox" id="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_date' )); ?>" <?php checked( true, $settings['show_date'] ); ?> value="1" /></label></p>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'show_user' )); ?>"><?php esc_html_e( 'Show reply author:',       'bbpress' ); ?> <input type="checkbox" id="<?php echo esc_attr($this->get_field_id( 'show_user' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_user' )); ?>" <?php checked( true, $settings['show_user'] ); ?> value="1" /></label></p>
