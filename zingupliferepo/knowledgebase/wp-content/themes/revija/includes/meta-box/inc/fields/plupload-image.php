...
if ( ! class_exists( 'RWMB_Plupload_Image_Field' ) )
{
	class RWMB_Plupload_Image_Field extends RWMB_Image_Field
	{
		...
		static function html( $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_plupload_image_drop_string', _x( 'Drop images here', 'image upload', 'revija' ), $field );
			$i18n_or     = apply_filters( 'rwmb_plupload_image_or_string', _x( 'or', 'image upload', 'revija' ), $field );
			$i18n_select = apply_filters( 'rwmb_plupload_image_select_string', _x( 'Select Files', 'image upload', 'revija' ), $field );
		...
		static function normalize_field( $field )
		{
			$field['js_options'] = array(
				...
				'filters'				=> array(
					array(
						'title'      => _x( 'Allowed Image Files', 'image upload', 'revija' ),
