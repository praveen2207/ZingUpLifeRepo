			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button button_grey submit"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
