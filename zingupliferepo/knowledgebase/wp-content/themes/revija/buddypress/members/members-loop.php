...
<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
	...
	<ul id="members-list" class="item-list activity_list">
	...
	<?php while ( bp_members() ) : bp_the_member(); ?>
		...
		<li <?php bp_member_class(); ?>>
			...
			<div class="item post_text">
				<div class="clearfix">
				  <a href="<?php bp_member_permalink(); ?>" class="f_left"><h5><?php bp_member_name(); ?></h5></a> 
				...
				<div class="event_activity"><?php bp_member_last_active(); ?></div>
