<div id="buddypress">
	...
	<div class="page" id="activate-page">
		...
		<?php if ( bp_account_was_activated() ) : ?>
			...
			<?php else : ?>
				<p><?php printf( esc_html__( 'Your account was activated successfully! You can now <a href="%s">log in</a> with the username and password you provided when you signed up.', 'buddypress' ), wp_login_url( bp_get_root_domain() ) ); ?></p>
			<?php endif; ?>
