...
<?php if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				<li>
					<a href="#post-topic-reply"><?php esc_html_e( 'Reply', 'buddypress' ); ?></a>
				</li>
		...
		<div id="topic-meta">
			<h3><?php esc_html_e( 'Edit:', 'buddypress' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)</h3>
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<label for="topic_title"><?php esc_html_e( 'Title:', 'buddypress' ); ?></label>
				<input type="text" name="topic_title" id="topic_title" value="<?php bp_the_topic_title(); ?>" maxlength="100" />

				<label for="topic_text"><?php esc_html_e( 'Content:', 'buddypress' ); ?></label>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'This topic does not exist.', 'buddypress' ); ?></p>
	</div>
