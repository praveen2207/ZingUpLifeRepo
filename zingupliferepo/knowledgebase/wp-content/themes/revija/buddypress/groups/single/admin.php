...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p>
	    <input id="group-notify-members"  type="checkbox" name="group-notify-members" value="1" />
		<label for="group-notify-members">
			 <?php esc_html_e( 'Notify group members of these changes via email', 'buddypress' ); ?>
		</label>
	</p>
	...
	<p><input class="button button_grey"  type="submit" value="<?php esc_attr_e( 'Save Changes', 'buddypress' ); ?>" id="save" name="save" /></p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<?php if ( bp_is_active( 'forums' ) ) : ?>
		...
		<?php if ( bp_forums_is_installed_correctly() ) : ?>
			...
			<div class="checkbox">
				...
				<label for="group-show-forum"> <?php esc_html_e( 'Enable discussion forum', 'buddypress' ); ?></label>
			</div>
	...
	<div class="radio">
			...
			<input  id="group-status-public"  type="radio" name="group-status" value="public"<?php bp_group_show_status_setting( 'public' ); ?> />
		<label  for="group-status-public" ><strong><?php esc_html_e( 'This is a public group', 'buddypress' ); ?></strong></label>
			...
			<input   id="group-status-private"  type="radio" name="group-status" value="private"<?php bp_group_show_status_setting( 'private' ); ?> />
			<label  for="group-status-private" ><strong><?php esc_html_e( 'This is a private group', 'buddypress' ); ?></strong></label>
			<ul>
			...
			<input  id="group-status-hidden" type="radio" name="group-status" value="hidden"<?php bp_group_show_status_setting( 'hidden' ); ?> />
			<label  for="group-status-hidden" ><strong><?php esc_html_e( 'This is a hidden group', 'buddypress' ); ?></strong></label>
			<ul>
	...
	<div class="radio">
			...
			<label for="group-invite-status-members" ><strong><?php esc_html_e( 'All group members', 'buddypress' ); ?></strong></label>
			...
			<label for="group-invite-status-mods" ><strong><?php esc_html_e( 'Group admins and mods only', 'buddypress' ); ?></strong></label>
			...
			<label for="group-invite-status-admins" ><strong><?php esc_html_e( 'Group admins only', 'buddypress' ); ?></strong></label>
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget section_7">
		<h3 class="section_title"><?php esc_html_e( 'Administrators', 'buddypress' ); ?></h3>
		<?php if ( bp_has_members( '&include='. bp_group_admin_ids() ) ) : ?>

		<ul id="admins-list" class="item-list single-line activity_list">

			<?php while ( bp_members() ) : bp_the_member(); ?>
			<li>
				<div class="post_photo">
				<?php echo bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'type' => 'full', 'width' => 80, 'height' => 80, 'alt' => sprintf( esc_html__( 'Profile picture of %s', 'buddypress' ), bp_get_member_name() ) ) ); ?>
				</div>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		<div class="bp-widget  section_7">
			<h3 class="section_title"><?php esc_html_e( 'Moderators', 'buddypress' ); ?></h3>
			
			<?php if ( bp_has_members( '&include=' . bp_group_mod_ids() ) ) : ?>
				<ul id="mods-list" class="item-list single-line  activity_list">
	...
	<div class="bp-widget  section_7">
		<h3 class="section_title"><?php esc_html_e("Members", "buddypress"); ?></h3>
		...
		<?php if ( bp_group_has_members( 'per_page=15&exclude_banned=0' ) ) : ?>
			...
			<ul id="members-list" class="item-list single-line  activity_list">
