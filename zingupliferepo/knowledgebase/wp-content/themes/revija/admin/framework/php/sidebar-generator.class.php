<?php
if (!class_exists('REVIJA_SIDEBAR')) {

	class REVIJA_SIDEBAR extends REVIJA_FRAMEWORK {
		...
		function __construct($options) {
		    ...
		    $this->title = REVIJA_THEMENAME ." ". esc_html__('Custom Widget Area', 'revija');
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script( REVIJA_PREFIX . 'custom_sidebar_js' , $this->paths['js'] . 'custom_sidebar.js');
			wp_enqueue_style( REVIJA_PREFIX . 'custom_sidebar_css' , $this->paths['css'] . 'custom_sidebar.css');
		}
		...
		public function add_field() {
			...
			$output .= "\n  <h3>". $this->title ."</h3>";
			$output .= "\n    <p><input size='30' type='text' value='' placeholder = '". esc_html__('Enter Name for new Widget Area', 'revija') ."' name='form-add-widget' /></p>";
			$output .= "\n    <input class='button button-primary' type='submit' value='". esc_html__('Add Widget Area', 'revija') ."' />";
