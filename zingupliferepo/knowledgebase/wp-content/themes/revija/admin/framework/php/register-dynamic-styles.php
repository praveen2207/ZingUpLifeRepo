...
if (!function_exists('revija_pre_dynamic_stylesheet')) {

	function revija_pre_dynamic_stylesheet () {

		$options = mad_custom_get_option();

		$styles	= $custom = array();

		//include(REVIJA_FRAMEWORK::$path['configPath'] . 'register-color-schemes.php');
		...
		require(REVIJA_BASE_PATH . 'css/dynamic-global-css.php');
	}
}
