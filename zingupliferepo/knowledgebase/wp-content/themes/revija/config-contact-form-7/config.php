...
if (!class_exists('REVIJA_CONTACT_FORM_7_CONFIG')) {

	class REVIJA_CONTACT_FORM_7_CONFIG {

		public $paths = array();

		function __construct() {
			$this->paths = array(
				'BASE_URI' => REVIJA_BASE_URI . trailingslashit('config-contact-form-7'),
	...
	new REVIJA_CONTACT_FORM_7_CONFIG();
}
