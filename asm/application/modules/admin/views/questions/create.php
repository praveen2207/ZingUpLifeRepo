...
<style>
    ...
    <input type="hidden" id="question_id" name="question_id" value="<?php echo $question_id; ?>">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <input type="hidden" id="answer_count" name="answer_count" value="6">
        ...
        <div class="col-lg-12 " >
            <div class="box-footer centered">
                <button type="submit" value="save" class="btn btn-primary" id="btn_save" name="btn_save" onclick="return validate_answers();"><?php echo $action_button_text;?></button>
              </div>
        </div>
        <!--/.col (right) -->
        <?php echo form_close(); ?>
  ...
  <script>
    ...
    function load_answer_type(answer_type){
        ...
        {
            jQuery( ".img_control" ).after('<div class="qType"><input class="form-control-short single_box" onkeypress="return float_validation(event, this.value)" type="text" placeholder="" readonly name="answer_single_weightage[]"/>&nbsp;<input type="radio" onclick="single_click()" value="1" class="single_field" id="single_field" name="answer_single"/>&nbsp;&nbsp;Answer</div>');
        }

        if(answer_type=='MULTIPLE')
        {
            jQuery( ".img_control" ).after('<div class="qType"><input onkeypress="return float_validation(event, this.value)" class="form-control-short multi-box" type="text" placeholder="" readonly name="answer_text_multiple[]"/>&nbsp;<input type="checkbox" value="yes" onclick="multiple_click()"    name="answer_check_multiple" />&nbsp;&nbsp;Answers</div>');
        }

        if(answer_type=='WEIGHTAGE')
        {
            jQuery( ".img_control" ).after('<div class="qType"><input placeholder="Weightage" onkeypress="return float_validation(event, this.value)" class="form-control-short" type="input" name="answer_weightage[]"/></div>');
        }
    }
