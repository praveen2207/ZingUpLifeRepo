			...
			<li>
				<?php
					...
					if ( is_numeric( $download['downloads_remaining'] ) )
						echo apply_filters( 'woocommerce_available_download_count', '<span class="count">' . sprintf( '%s download remaining', '%s downloads remaining', $download['downloads_remaining'] ) . '</span> ', $download );
