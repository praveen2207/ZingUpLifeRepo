...
if (!class_exists('REVIJA_WIDGETS_META_BOX')) {

	class REVIJA_WIDGETS_META_BOX {
		...
		function __construct () {
			...
			$this->paths = array(
				'PHP' => REVIJA_BASE_PATH . 'config-widget-meta-box/' . trailingslashit('php'),
				'ASSETS_DIR_NAME' => 'assets',
				'BASE_URI' => REVIJA_BASE_URI . trailingslashit('config-widget-meta-box')
			);
		...
		public function admin_enqueue_scripts() {
			...
			wp_enqueue_style(REVIJA_PREFIX . 'widget-meta-box', $css_file);
			wp_enqueue_script(REVIJA_PREFIX . 'widget-meta-box', $js_file, array('jquery'), 1, true);
		}

		public function add_meta_box() {
			add_meta_box("widets_footer_meta_box", esc_html__("Widgets Row Footer", "revija"), array(&$this, 'draw_widgets_meta_box' ), "page", "normal", "low");
		}
		...
		public function get_registered_sidebars() {
			$registered_sidebars = REVIJA_HELPER::get_registered_sidebars();
