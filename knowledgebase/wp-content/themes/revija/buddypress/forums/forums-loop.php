...
<?php if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
	...
	<table class="forum">
		<thead>
			<tr>
				<th id="th-title"><?php esc_html_e( 'Topic', 'buddypress' ); ?></th>
				<th id="th-postcount"><?php esc_html_e( 'Posts', 'buddypress' ); ?></th>
				<th id="th-freshness"><?php esc_html_e( 'Freshness', 'buddypress' ); ?></th>
		...
		<tbody>
			...
			<tr class="<?php bp_the_topic_css_class(); ?>">
				<td class="td-title">
					...
					<p class="topic-meta">
						<span class="topic-by"><?php /* translators: "started by [poster] in [forum]" */ printf( esc_html__( 'Started by %1$s', 'buddypress' ), bp_get_the_topic_poster_avatar( 'height=20&width=20') . bp_get_the_topic_poster_name() ); ?></span>
						...
						<?php if ( !bp_is_group_forum() ) : ?>
							...
							<span class="topic-in">
								...
								<?php
									...
									printf( esc_html__( 'in %1$s', 'buddypress' ), $topic_in );
								?>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'Sorry, there were no forum topics found.', 'buddypress' ); ?></p>
	</div>
