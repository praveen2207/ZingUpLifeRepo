...
if (!empty($tags) && is_array($tags)) {
	...
	$query = array(
		'post_type' => 'portfolio',
		'numberposts' => mad_custom_get_option('related_portfolio_count'),
		...
		<?php if (!empty($entries)): ?>
			...
			<div class="section photo_gallery">
				...
				<h3 class="section_title">
					<?php esc_html_e('Related Portfolio', 'revija'); ?>
				</h3>
				...
				<div class="row">
					...
					<?php foreach($entries as $post): setup_postdata($post); ?>
						...
						<div <?php post_class($post_class); ?> id="post-<?php the_ID(); ?>">
							...
							<?php echo mad_blog_portfolio_th_btn($id, $title, '165*110', 'grid'); ?>
