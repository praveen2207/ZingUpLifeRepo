(function ($) {
    ...
    $.fn.cwAllowCookies = function (options) {
		...
		var html = "<div class=\"cookie cwcookielaw\">" +
          "<div class=\"container\">" +
            "<div class=\"clearfix\">" +
              "<span>" + options.cwmessage + "</span>" +
              "<div class=\"f_right\">" +
			  "<a href=\"#\" class=\"cwallowcookies button button_type_3 button_orange\">" + options.cwagree + "</a>" +
			  "<a class=\"cwcookiesmoreinfo button button_type_3 button_grey_light\" target='_blank' href="+ options.cwmoreinfohref +">" + options.cwmoreinfo + "</a>" +
			  "</div>" +
            "</div>" +
          "</div>" +
        "</div><!-- cwcookielaw -->";
