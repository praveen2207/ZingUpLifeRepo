	...
	<?php if (!empty($taxonomies)) {
            ...
            <div class="woof_container">
                ...
                <div class="woof_container_inner">
					...
					<?php switch ($woof_settings['tax_type'][$tax_slug]) {
                        case 'checkbox': ?>
                            <span class="woof_label"><?php echo esc_html($taxonomies_info[$tax_slug]->labels->name); ?></span>
		...
		if ($show_reset) {
			...
			if ( count( $_chosen_attributes ) > 0 || $min_price > 0 || $max_price > 0 ) {
				...
				echo "<a class='woof-reset-navigation' href='{$link}'>" . esc_html__( 'Reset', 'revija') . "</a>";
				echo ob_get_clean();
			}
