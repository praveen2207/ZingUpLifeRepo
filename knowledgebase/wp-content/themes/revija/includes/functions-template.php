...
if (!function_exists( 'mad_header_type_6_top_part' )) {
	function mad_header_type_6_top_part() {
		mad_get_template( '/header/header-type-6-top-part.php' );
	}
}
...
if (!function_exists( 'mad_header_logo_type_7' )) {
	function mad_header_logo_type_7() {
		mad_get_template( '/header/logo-type-7.php' );
	}
}
...
if (!function_exists( 'mad_searchform_type_2' )) {
	function mad_searchform_type_2() {
		mad_get_template( '/header/searchform-type-2.php' );
	}
}


if (!function_exists( 'mad_searchform_type_4' )) {
	function mad_searchform_type_4() {
		mad_get_template( '/header/searchform-type-4.php' );
	}
}

if (!function_exists( 'mad_searchform_type_5' )) {
	function mad_searchform_type_5() {
		mad_get_template( '/header/searchform-type-5.php' );
	}
}
...
if (!function_exists( 'mad_navigation_type_6' )) {
	function mad_navigation_type_6() {
		mad_get_template( '/header/navigation-type-6.php' );
	}
}
...
/* ---------------------------------------------------------------------- */
/*	Template: Portfolio Video Slider
/* ---------------------------------------------------------------------- */

if (!function_exists( 'mad_portfolio_video_slider' )) {
	function mad_portfolio_video_slider() {
		mad_get_template( '/sliders/portfolio-video-slider.php' );
	}
}
/* ---------------------------------------------------------------------- */
...
if (!function_exists( 'mad_post_extended_image' )) {
	function mad_post_extended_image() {
		mad_get_template( '/content/post-extended.php' );
	}
}
