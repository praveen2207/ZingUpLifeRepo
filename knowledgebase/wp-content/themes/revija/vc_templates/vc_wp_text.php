...
$atts['filter'] = false; //Hack to make sure that <p> added
extract( $atts );
...
$args['before_widget'] = '<div class="section widget %s" >';
$args['after_widget'] = '</div>';
$args['before_title'] = '<div class="widget-head"><h3 class="section_title">';
