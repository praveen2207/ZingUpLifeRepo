...
<head>
   <meta name="google-site-verification" content="qEw3ux_M-eIw_ld_Q4fxhiX3p6yIhXgcXqchxTSIciw" />
    ...
    .dropdown-content a:hover {color: #4CAF50;}
            ...
            <div class="nav-inner row-content buffer-left buffer-right even clear-after">
                ...
                <nav>
                    <ul class="reset" role="navigation">
                        ...
                        <div class="dropdown">
                          <div class="dropbtn">For Companies</div>
                          <div class="dropdown-content">
                            <a href="<?php echo base_url(); ?>workplace-offerings">Workplace Offerings</a>
                            <a href="<?php echo base_url(); ?>workplace">Assessment Home</a>
                            <a href="<?php echo base_url(); ?>knowledgebase/">Knowledge Base</a>
                          </div>
                        </div>
                        
                        </li>  
                        <li><a href="<?php echo base_url(); ?>contact_us" style="color:#3fab3c;">Contact Us</a></li>                       
                        <li class="menu-item">                            
...
<!--                         <li data-toggle="offcanvas" data-target=".navmenu"> 
    ...
    <div class="hidden-xs hidden-sm" role="banner" id="header" style="position:fixed;z-index:100;width: 100%;border-radius: 0px;height:85px;margin-top:0px;background-color:#fff;border-bottom:1px solid #ebebeb">
        <div class="row" style="top:5px;">
        <!-- <div style="padding-right:155px; float:right; font-size:13px;padding-right: 155px;font-size: 13px;position: absolute;right: 0;">24/7 Support&nbsp;&nbsp;&nbsp;+91 98863 50650  |  support@zinguplife.com</div> -->
            <div class="nav-inner col-lg-12 row-content buffer-left buffer-right even clear-after" style=" position: absolute; left: 23px; margin-top: 20px;   min-width: 1368px;">
                <div id="brand">
                ...
                ">
                    <ul class="reset" role="navigation">
                        ...
                        <li><a href="<?php echo base_url(); ?>contact_us" style="color:#3fab3c;">Contact Us</a></li>                       
                        <li class="menu-item">                            
                            <a href="<?php echo base_url(); ?>login"><button type="submit" style="padding:0" class="btn btn-lg btn-login">&nbsp;&nbsp;&nbsp;Login&nbsp;&nbsp;&nbsp;</button></a>                        
                        </li>					 
                        <?php } ?>
                        <?php if ($is_logged_in == 1) { ?>						
                        <li>
