...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="admin_vendor_one_time_slots" name="serviceslots" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/business_service_adding_slot">  
        <fieldset>
            <div class="clear">
