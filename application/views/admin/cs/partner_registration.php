...
<div class="row-fluid user-detail-row1">
    ...
    <form class="form-horizontal for partner1" name="partner_register" id="cs_partner_register" action="<?php echo base_url(); ?>cs/add_partner_registration" method="post">  
        <fieldset>
            <div class="clear">
                ...
                <div class="edit-group3 edt3">          
                    ...
                    <div class="customer-edit-input">
                        <ul class="cs_business_services">
                            ...
                            <?php } ?>
                          <label class="error" id="cs_business_type"  style="display:none;color:red;" generated="true" for="name">This Field is Required.</label>
                        </ul>
