...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_vendor_service_slots" name="serviceslots" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/adding_business_service_slots">  
        <fieldset>
            <div class="clear">
