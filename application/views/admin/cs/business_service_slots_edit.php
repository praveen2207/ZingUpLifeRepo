...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1 bsr-slots" id="cs_vendor_service_slot_edit_form" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/update_business_services_slots">  
        <fieldset>
            <div class="clear">
...
<div class="error_slot_date" style="display:none; color:red;">This Field is required</div>
                ...
                <div class="edit-group3"> 
                    ...
                    <div class="customer-edit-input">
                        <div id="start-date-end-date11">
                            <select id="select01"  name="slots_time" class="required p-select valid slots_time">
  ...
  <div class="cs_error_slot_timings" style="display:none; color:red;">This Field is required</div>
                        </div>
                    </div> 
                </div> 
                <div class="edit-group3"> 
