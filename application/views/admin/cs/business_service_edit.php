...
<div class="row-fluid tr-row">
    <div class="" >
                        ...
                        <?php if ($services['details']->service_type == 'monthly') { ?>
                            <div class="add_new"><a href="<?php echo base_url(); ?>cs/offerings_memberships/<?php echo $services['details']->id; ?>" class="button new-button">Add Membership</a></div>
                        <?php } elseif ($services['details']->service_type == 'one_time' && count($services['slots']) == 0) { ?>
                            <div class="add_new"><a href="<?php echo base_url(); ?>cs/business_service_add_slot/<?php echo $services['details']->id; ?>" class="button new-button">Add One Time Slot</a></div>
                        <?php } elseif ($services['details']->service_type == 'hourly') { ?>
                            <div class="add_new"><a href="<?php echo base_url(); ?>cs/business_service_slots/<?php echo $business_id; ?>" class="button new-button">Add Business Hours</a></div>
                            <?php
                        } else {
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_vendor_business_service_edit_form" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/updating_business_services">  
        <fieldset>
            <div class="clear">
                                            ...
                                            <tr>
                                                ...
                                                <td clas="blue">
                                                    <ul class="backend-actions">
                                                        <li><a class="blue" href="<?php echo base_url(); ?>cs/service_slots_edit/<?php echo $services['details']->id . '_' . $key; ?>">Edit</a></li>
                                                        <li>|</li>
                                    ...
                                    foreach ($services['slots'] as $key => $value) {
                                        ...
                                        if (!empty($value)) {
                                            ...
                                            <tr>
                                                ...
                                                <td clas="blue">
                                                    <ul class="backend-actions">
                                                        <li><a class="blue" href="<?php echo base_url(); ?>cs/one_time_service_slots_edit/<?php echo $services['details']->id . '_' . $values->id; ?>">Edit</a></li>
                                                        <li>|</li>
                                ...
                                if (!empty($services['memberships'])) {
                                     foreach ($services['memberships'] as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td clas="blue">
                                                    <ul class="backend-actions">
                                                        <li><a class="blue" href="<?php echo base_url(); ?>cs/edit_offerings_memberships/<?php echo $value->id; ?>">Edit</a></li>
                                                        <li>|</li>
...
<script>
    ...
    $('body').on('click', '.service_slots_delete', function () {
        ...
        if (confirm("Are you sure you want to delete these slots!") == true)
        {
            $.ajax({
                type: 'POST',
                url: base_url + 'cs/service_slots_delete',
                data: {id: id},
                dataType: "json",
