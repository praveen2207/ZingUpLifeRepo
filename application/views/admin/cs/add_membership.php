...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" id="cs_vendor_add_one_day_pack" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/create_offerings_memberships">  
