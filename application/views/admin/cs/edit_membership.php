...
<div class="row-fluid tr-row">
    ...
    <form class="form-horizontal for user-detail-row1 partner1 infob1" name="service" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>cs/update_offerings_memberships">  
        <fieldset>
            <div class="clear">
