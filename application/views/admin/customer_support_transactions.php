...
<div class="row-fluid tr-row">	  
    <div class="sorting-section">
        <p class="sorting-para s-para">
            <span class=" sorting-span">List Showing</span>
...
<!--                <i class="fa fa-angle-down"></i>-->
        ...
        <p class="sorting-para">
            ...
            <i class="fa fa-angle-down date-arrow blue" id="dp4" data-date-format="yyyy/mm/dd" data-date="<?php echo $current_date; ?>"></i>
        </p>
        <p class="sorting-para spara1">
            ...
            <i class="fa fa-angle-down date-arrow blue" id="dp5" data-date-format="yyyy/mm/dd" data-date="<?php echo $end_date; ?>"></i>
        </p>
   ...
   <div class="filter-section" id="admin_transactions_filter_section">
    ...
    <div class='trans-tabledata' style='display:none;'>	
        ...
        <div class="sorting-section">
            <p class="sorting-para s-para"><span class="sorting-span">List Showing booking date</span><span class=" sorting-span "> from</span><span class="blue  sorting-span sort-span" id="startDate"> <?php echo $current_date; ?></span>
                <span class="sorting-span "> to</span><span class="blue  sorting-span sort-span" id="endDate"> <?php echo $end_date; ?></span>
            </p>
                ...
                <?php foreach ($all_transactions as $key => $value) { ?>
                    ...
                    <tr  id="<?php echo $value['user_details']->id . '-' . $value['transactions']->booking_id . '-' . $value['transactions']->slot_id; ?>">
                        ...
                        <td><?php echo date('Y/m/d', strtotime($value['transactions']->booking_date)); ?><br/>
                            <?php
                            $booking_timing = date('h:i A', strtotime($value['transactions']->booking_date));
                          echo $booking_timing;
                            ?> 
                        </td>
                        ...
                        <td><span class="blue v-name word_break word_break_down"><?php echo $value['transactions']->services; ?></span><br/>
                            <?php
                        ...
                        <td><?php echo date('Y/m/d', strtotime($value['transactions']->date)); ?><br/>
                            <?php
                            $treatment_timing = date('h:i A', strtotime($value['transactions']->start_time));
                           
                            echo $treatment_timing;
                            ?> </td>			
...
<?php } ?>
    ...
    <table id="example" class="display" cellspacing="0" width="100%" >	 
        ...
        <tbody id="cs_transactions_filter" class="searchcontent">  
                    <?php foreach ($all_transactions as $key => $value) { ?>
                            ...
                            <ul class="actions-list">		
                                <li><?php
                                    if ($value['transactions']->expiry == 'no') {
                                        if (isset($value['mark_attend']->status)) {
                                            if ($value['mark_attend']->status == 'Not-attended') {
                                                ?><a id="<?php echo $value['user_details']->id . '-' . $value['transactions']->booking_id . '-' . $value['transactions']->slot_id; ?>" class="blue markattend" href="">Mark as Attended</a><?php } else { ?>Attended <?php
                                                }
                                            }
                                        }
                                        ?></li>	
                                <li><a id="<?php echo $value['user_details']->id . '-' . $value['transactions']->booking_id . '-' . $value['transactions']->slot_id; ?>" class="blue" href=""><?php
                                    if ($value['transactions']->expiry == 'no') {
                                        if ($value['transactions']->booking_status == 'Pending') {
                                                ?>Remind Customer<?php
                                            }
                                        ...
                                        ?></a></li>	
                                <li><a id="<?php echo $value['user_details']->id . '-' . $value['transactions']->booking_id . '-' . $value['transactions']->slot_id; ?>" class="green" href=""><?php
                                    if ($value['transactions']->expiry == 'no') {
                                        ...
                                        ?></a></li>
                                <li><a id="<?php echo $value['user_details']->id . '-' . $value['transactions']->booking_id . '-' . $value['transactions']->slot_id; ?>"class="blue" href="<?php echo base_url(); ?>customer_support/order_details/<?php echo $value['transactions']->booking_id; ?>">View Order Detail</a></li>
                            </ul>	
                        </div>
                    </td>
                </tr>
