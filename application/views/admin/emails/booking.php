                        ...
                        <tr>
                            <td style="padding: 10px  22px 10px;">
                                <table width="193" align="left" border="0" cellpadding="0" cellspacing="0">  
                                    <tr>
                                        <td>
                                            <span style="color:#444;font-family: 'Quattrocento Sans', sans-serif;font-size:14px;font-weight:bold;display:block;margin-top:10px;">ID: <?php echo $get_transaction_details->transaction_id; ?></span>
                            ...
                            <td style="border-top:1px solid #bebebe;padding: 17px 23px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                    <tr>
                                        ...
                                        <td style="text-align:left; font-size:41px;vertical-align:top;width:155px;">
                                            <p style="color:#444;font-weight:normal;padding:0px;margin:0px;font-family: 'Quattrocento Sans', sans-serif;font-size:13px;"><label style="color:#444;font-size:15px;">Contact Customer Support:</label><span style="display:block;font-size:19px;margin-top:5px;line-height:27px;color: #038d26;"><?php echo $business_details->phone; ?></span></p>
                                        </td>
