<div class="location-header admin-header">
    <h3 class="redirect-head admin-head pull-left">Vendors</h3>
	<a class="add_vendor" href="<?php echo  base_url(); ?>cs/partner_registration" >ADD NEW</a>
</div>

<div class="row-fluid tr-row">

  <?php
    $error_message = $this->session->flashdata('vendor_registration_message');
    if ($error_message) {
        ?>
...
<div class='trans-tabledata' style='display:none;'>
	...
	<table border="1" class="display" cellspacing="0" cellpadding="10" width="100%" >
        <thead>
            <tr>
            ...
            <?php foreach ($all_vendors as $key => $value) { ?>
                <tr>
                    <td class=""><span class="blue v-name">
                            <a class="blue mail-id" href="<?php echo base_url();?>customer_support/vendor_details/<?php echo $value->id; ?>"><?php echo $value->name; ?></a>
                        </span>
                    </td>
    ...
    <div class="filter-section filter-section1 vendor-all-filter">
            ...
            <tbody class='searchcontent'>
                <?php foreach ($all_vendors as $key => $value) { ?>
                    <tr>
                        ...
                        <td class=""><?php echo $value->area_name; ?></td>
                        <td class=""><span class="blue v-name word_break_down"><a id="<?php echo $value->business_id; ?>" href="" class="blue batch cs_delete_vendor">Delete Vendor</a></span></td>
