...
<!--            <i class="fa fa-angle-down"></i>-->
    ...
    <?php $current_time = date('y-m-d'); if(strtotime($reschedule_details['transactions']->date) > strtotime($current_time)){ ?><a class="sign-link sign-now-link" href="<?php echo base_url(); ?>customer_support/reschedule_order/<?php echo $reschedule_details['transactions']->booking_id; ?>"><i class="fa fa-angle-right sign-arrow"></i> Re-schedule this order</a>
