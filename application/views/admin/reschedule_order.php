...
<div class="row-fluid order-row">
    ...
    <div class="span12 span17">
        ...
        <a href="<?php echo base_url(); ?>customer_support/reschedule_date/<?php echo $reschedule_details['transactions']->booking_id; ?>" class="primary-small re-edit re-edit1">Edit Date</a>
    ...
    <div class="span12 span17">
        ...
        <h5 class="res-head table-head medium"><i class="fa fa-check"></i>2. Time: <?php
            ...
            ?></h5>
        <a href="<?php echo base_url(); ?>customer_support/reschedule_time/<?php echo $reschedule_details['transactions']->booking_id; ?>" class="primary-small re-edit re-edit1">Edit Time</a>
