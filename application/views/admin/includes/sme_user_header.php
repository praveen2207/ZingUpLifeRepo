                ...
                <?php } else {
                    ...
                    <div class="nav-collapse">
                        <ul class="menu-section" id="admin_menu">
							...
							<?php if ($url == 'admin/sme_users') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_users" class="admin_menu_link nav-sel">SME</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_users" class="admin_menu_link">SME</a></li>
                            <?php } ?>
                        ...
                        <ul class="user-menu-section">
							...
							<?php if ($sub_url == 'sme_events') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_events" class="admin_menu_link nav-sel">Events</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_events" class="admin_menu_link">Events</a></li>
                            <?php } ?>
                            
                            <?php if ($sub_url == 'sme_articles') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_articles" class="admin_menu_link nav-sel">Articles</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme_articles" class="admin_menu_link">Articles</a></li>
                            <?php } ?>
							
							<?php if ($sub_url == 'sme_amount') { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme/sme_amount" class="admin_menu_link nav-sel">Questions Amount</a></li>
                            <?php } else { ?>
                                <li><a href="<?php echo base_url(); ?>admin/sme/sme_amount" class="admin_menu_link">Questions Amount</a></li>
                            <?php } ?>
