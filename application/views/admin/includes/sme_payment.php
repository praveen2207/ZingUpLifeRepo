							...
							<div class="row-fluid notify" style="display:none;">
								<div class="span12 no-border">
									...
									<div class="tdetail-con">
										<form method="post" name="customerData" action="<?php echo base_url(); ?>questions/payment_process" id="paymentForm">
											...
											<table width="40%" height="100" border='1' align="center">
												...
												<tr>
													<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?php echo base_url(); ?>questions/payment_success"/></td>
												</tr>
												<tr>
													<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?php echo base_url(); ?>questions/payment_canceled"/></td>
												</tr>
												<tr>
