...
<script src="<?php echo base_url(); ?>assets/admin/js/cs_custom.js"></script>
    ...
    $(document).ready(function () {
        ...
        $("#add-block").click(function () {
            ...
            if (count <= 9) {
               ...
               clone.find('.error_start_time_validate').hide();
               clone.find('.error_end_time_validate').hide();
...
<script type="text/javascript" >
$(document).ready(function(){
$("#cs_vendor_service_slots").on("submit", function(e){
	 var start_ids = [];
	 var end_ids = [];
...
$(document).ready(function(){
     		...
     		$("#cs_vendor_one_time_slots").on("submit", function(e){
	 var start_ids = [];
	 var end_ids = [];
 	$(".add-time-block").each(function (index) { 
     var start_time = $(this).find('#start-time').val();
     ...
     if(start_time == ''){
     	e.preventDefault();
     	$(this).find('.error_start_time_validate').show();
     	}
     	
     	if(end_time == ''){
     	e.preventDefault();
     	$(this).find('.error_end_time_validate').show();
     	}
     if(start_time != '' && end_time!='')
     {
       $(this).find('.error_start_time_validate').hide();
       $(this).find('.error_end_time_validate').hide();
     	if(start_time > end_time){
     		start_ids.push(index);
...
<script type="text/javascript" >
$(document).ready(function(){
$("#cs_vendor_service_slot_edit_form").on("submit", function(e){
...
if(slots_time == ''){
         $('.cs_error_slot_timings').show();
         e.preventDefault();
        }
        else{

$('.cs_error_slot_timings').hide();
       }
     	if(start_time > end_time){
...
<script type="text/javascript" >
$(document).ready(function(){
$("#cs_one_time_slot_edit_form").on("submit", function(e){
