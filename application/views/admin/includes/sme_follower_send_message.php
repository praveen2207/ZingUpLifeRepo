                                ...
                                <div class="dashboard-right"> 
                                	<div class="dashboard-right-inner">
                                        ...
                                        <div class="dashboard-content-inner">
                                            ...
                                            <h2 class="dashboard-title ">Send Message</h2>
                                            <div class="dashboard-content-boxinner">
                                            <form action='<?php echo base_url(); ?>followers/send_message' method='post'>
												<label>Message</label>
												<textarea name='message'></textarea>
												<input type='hidden' name='user_id' class='user_id' value='<?php echo $this->uri->segment(3); ?>' />
