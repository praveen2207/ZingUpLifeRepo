        ...
        <div id="intro-wrap">
            <div id="intro" class="preload darken" data-autoplay="5000" data-navigation="true" data-pagination="true" data-transition="fadeUp">
                <div class="intro-item intro-item-image " style="background-color: #363842; background-image: url(<?php echo base_url();?>assets/zing_new/img/banner1.jpg);">
                    ...
                    <div class="row">  
                        <div class="hexagon1_text" style="z-index:1"><?php if($assessment_1_theme_id!=null){ ?><a style="text-decoration:none;" onclick="bio_asses_theme();"><?php echo $assessment_1['theme_name'];?></a><?php } ?></div>
                        <div class="hexagon2_text" style="z-index:1; text-align: left;"><?php if($assessment_2_theme_id!=null){ ?>
                        <a style="text-decoration:none; float: right; margin-right: -25px;" onclick="diet_asses_theme();"><?php echo $assessment_2['theme_name'];?></a>
                        <?php } ?></div>
                        <?php if($this->input->cookie("org_assessment")){?>
                        <div class="hexagon3_text" style="z-index:1"><?php if($assessment_4_theme_id!=null){ ?><a style="text-decoration:none;" onclick="wns_asses_theme();"><?php echo $assessment_4['theme_name'];?></a><?php } ?></div>
                        <?php }else{?>
                        <div class="hexagon3_text" style="z-index:1"><?php if($assessment_3_theme_id!=null){ ?><a style="text-decoration:none;" onclick="wns_asses_theme();"><?php echo $assessment_3['theme_name'];?></a><?php } ?></div>
                        <?php }?>
				...
				<input type="hidden" id="bio_test_id" value="<?php echo $assessment_1_level_id; ?>">
				    ...
				    <input type="hidden" id="diet_test_id" value="<?php echo $assessment_2_level_id; ?>">
                            ...
                            <div style="clear:both;"></div>
                                <div class="hexagon3">
				    <input type="hidden" id="org_wns_theme_id" value="<?php echo $assessment_4_theme_id; ?>">
				    <input type="hidden" id="org_wns_test_id" value="15">
				    ...
				    <input type="hidden" id="wns_test_id" value="<?php echo $assessment_3_level_id; ?>">
                        ...
                        <div class="col-md-6" style="clear: none !important;">    
                            <div style="position:absolute;padding-right: 195px; padding-top:85px; font-size: 19px; text-align: left;">
                            <h2 style="line-height: 46px; text-transform: uppercase; font-size: 42px; font-weight: bold;">Rediscover <br/> Yourself</h2>
                            <p style="font-size: 16px; line-height: 26px;">
                            	8BAK-C Wellness inventory <br>
                            	helps scientifically identify risks <br>
                            	and optimize you personal <br>
                            	health, happiness & wellbeing
                            </p>
                            </div>
                        	<a style="float:left; padding-top:288px; margin-left: -16px;" onclick="bio_asses_theme();">
                            	<img class="get_started" alt="Get Started" src="<?php echo base_url();?>assets/home_page/images/get_started.png" class="hexLink">
                            </a>
                        
                        </div>
                        <!-- 
                        <div class="col-md-6" style="clear: none !important;">    
                            <div style="position:absolute;padding-right: 195px; padding-top:350px;">
                            <a style="position:absolute;padding-right: 195px; padding-top:350px;" onclick="bio_asses_theme();">
                            	<img class="get_started" alt="Get Started" src="<?php echo base_url();?>assets/home_page/images/get_started.png" class="hexLink">
                            </a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3 class="section-heading-white" style="text-transform:none; color: #fff; font-size:22px;">Rediscover <br>yourself</h3>
                </div>
            </div>
          <div class="row">
            ...
            <div class="col-sm-12">
                <div class="col-xs-6">
                    ...
                    <div class="hexagon1_text_mobile" style="float:left;"><?php echo $assessment_1['theme_name'];?></div>
                    </a>
		</div>
            ...
            <div class="col-sm-12">
              <div class="col-xs-6">
                  ...
                  <div class="hexagon1_text_mobile" style="float:left;"><?php echo $assessment_2['theme_name'];?></div>
                  </a>
                </div>
            </div>
            <div style="clear:both;height:30px;"></div>
            <div class="col-sm-12">
              <div class="col-xs-6">
                  <a class="hexLink"  style="outline: 0;cursor: pointer;" onclick="wns_asses_theme();">
                    ...
                    <div class="hexagon1_text_mobile" style="float:left;"><?php echo $assessment_3['theme_name'];?></div>
                    </a>
		</div>
            </div>
            ...
            <section class="row section knowledge">
                <div class="row-content buffer even base clear-after">
					...
					<div class="column three last" style="margin-top:-121px;" >
					     ...
					     <a target="_blank" href="<?php echo base_url();?>zen-at-avani">
