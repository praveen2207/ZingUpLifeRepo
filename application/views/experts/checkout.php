                                	...
                                	<div class="col-xs-4">
                                    	<div class="checkout-box-inner">
                                            ...
                                            <div class="treatment-details">
												<form action='<?php echo base_url();?>experts/payment' method='post'>
                                            	...
                                            	<input type='hidden' name='sme_userid' value='<?php echo $sme_userid; ?>' />
												  <div class="smepacakges">
													<?php foreach($packages as $p) {?>
														<div class="smepackages_div" style='width:32%;'>
															<input type="radio" name="package" class='change_package'  amt="<?php echo $p->amount;?>" value="<?php echo $p->name;?>,<?php echo $p->amount;?>,<?php echo $p->max_number_of_questions;?>" <?php if($amount == $p->amount) {?>checked<?php } ?>><p><b><?php echo $p->name;?></b></p>
															<p class="package_amount">&#8377;<?php echo $p->amount;?></p>
															<p>Maximum questions:<?php echo $p->max_number_of_questions;?></p>
														</div>
													<?php } ?>
												</div>
