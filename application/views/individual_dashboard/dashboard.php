    ...
    <div class="webInterface">
		 <div class="row salutationDivision">
      			<div class="col-lg-12">
					<h2 style="color:black">Welcome back, <?php echo $logged_in_user_data->name;?>! 
					<span style="color:#99C989;font-weight:bold;font-size:0.6em;margin-top: 12px;" class="pull-right">Personalized Content and your wellness dashboard - all in one place &nbsp; &nbsp;
					</span>
					</h2>
      			</div>
		 </div>
		 ...
		 <div class="row">
			...
			<?php 
			$this->load->view('individual_dashboard/dashboard_mobile')
			?>
			</div>
