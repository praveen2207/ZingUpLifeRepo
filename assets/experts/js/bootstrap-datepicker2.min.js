...
! function(a) {
    ...
    a.fn.datepicker2 = n;
    var o = a.fn.datepicker2.defaults = {
            assumeNearbyYear: !1,
            autoclose: !1,
        ...
        p = a.fn.datepicker2.locale_opts = ["format", "rtl", "weekStart"];
    a.fn.datepicker2.Constructor = k;
    var q = a.fn.datepicker2.dates = {
            en: {
    ...
    r.template = '<div class="datepicker"><div class="datepicker-days"><table class="table-condensed">' + r.headTemplate + "<tbody></tbody>" + r.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-decades"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + '</table></div><div class="datepicker-centuries"><table class="table-condensed">' + r.headTemplate + r.contTemplate + r.footTemplate + "</table></div></div>", a.fn.datepicker.DPGlobal = r, a.fn.datepicker.noConflict = function() {
        return a.fn.datepicker2 = m, this
    }, a.fn.datepicker2.version = "1.6.1", a(document).on("focus.datepicker2.data-api click.datepicker2.data-api", '[data-provide="datepicker2"]', function(b) {
        var c = a(this);
